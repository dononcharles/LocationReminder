package com.schaldrack.locationreminder.data.local
 ...
 */
class RemindersLocalRepository(private val remindersDao: RemindersDao, private val ioDispatcher: CoroutineDispatcher = Dispatchers.IO) : ReminderDataSource {
    ...
    /**
     * Deletes a reminder from the db by its id
     * @param id the reminder id of the reminder to be deleted
     */
